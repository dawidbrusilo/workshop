...
namespace Warsztat.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Success:
                    ...
                    if (!UserManager.IsEmailConfirmed(user))
                    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Name = model.Name, LastName = model.LastName, City = model.City, Street = model.Street, Phone = model.Phone };
                ...
                if (result.Succeeded)
                {
                    ...
                    SendEmail.GmailUsername = "aplikacja.warsztat@gmail.com";
                    SendEmail.GmailPassword = "W@rszt@t198765@";

                    SendEmail mail = new SendEmail();
                    mail.ToEmail = model.Email;
                    mail.Subject = "Dziękujemy za założenie konta " + user.Name ;
                    mail.Body = "Potwierdź konto, klikając  <a href=\"" + callbackUrl + "\">tutaj</a>";
                    mail.IsHtml = true;
                    mail.Send();
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                SendEmail mail = new SendEmail();
                mail.ToEmail = model.Email;
                mail.Subject = "Witaj, " + user.Name;
                mail.Body = "Resetuj hasło, klikając  <a href=\"" + callbackUrl + "\">tutaj</a>";
                mail.IsHtml = true;
                mail.Send();
